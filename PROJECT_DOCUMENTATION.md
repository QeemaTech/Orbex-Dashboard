...
/shipments                     → ShipmentsListPage (protected)
/shipments/:shipmentId         → ShipmentDetailsPage (protected)
/merchant-orders               → MerchantOrdersListPage (protected, ADMIN only)
/merchant-orders/:merchantOrderId → MerchantOrderDetailsPage (protected)
