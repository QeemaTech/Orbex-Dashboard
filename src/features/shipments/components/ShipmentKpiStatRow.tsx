...
export type ShipmentKpiStatRowProps = {
  token: string
  filters: CsFilterValues
  /** Distinct React Query prefix vs list query (e.g. `shipments-kpis` / `cs-shipments-kpis`). */
  queryKeyPrefix: string
}

export function ShipmentKpiStatRow({
  token,
  filters,
  queryKeyPrefix,
}: ShipmentKpiStatRowProps) {
